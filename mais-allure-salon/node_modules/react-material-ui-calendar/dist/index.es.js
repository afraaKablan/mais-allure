...
var DisplayMonthlyCalendar = function DisplayMonthlyCalendar(props) {
  ...
  while (monthCounter < 12) {
    var _loop = function _loop(i) {
      ...
      rowsOfMonths.push(React.createElement(
        TableCell,
        { key: monthID },
        React.createElement(
          CardActionArea,
...
var DisplayDailyCalendar = function DisplayDailyCalendar(props) {
  ...
  while (day <= end) {
    var _loop = function _loop(i) {
      ...
      var cloneDay = day;
      daysOfWeek.push(React.createElement(
        TableCell,
        { key: formattedDate },
        React.createElement(
          CardActionArea,
          ...
          React.createElement(
            ...
            React.createElement(
              CardContent,
              null,
              isSameDay(day, today) ? React.createElement(
                Typography,
                {
                  align: "center",
                  color: "primary",
    ...
    eachWeek.push(React.createElement(
      TableRow,
      { key: weekNumber },
      daysOfWeek
    ));
...
var DisplayYearlyCalendar = function DisplayYearlyCalendar(props) {
  ...
  while (currentYear < yearEnd + 1) {
    var _loop = function _loop(i) {
      ...
      rowsOfYears.push(React.createElement(
        TableCell,
        { key: currentYear },
        React.createElement(
          CardActionArea,
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Calendar.__proto__ || Object.getPrototypeOf(Calendar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(ChevronLeftRounded, null)
        ),
        React.createElement(
          Button,
      ...
      return React.createElement(DisplayMonthlyCalendar, { onSetMonth: _this.onSetMonth, light: textColor });
      ...
      return React.createElement(
        ...
        React.createElement(DisplayYearlyCalendar, {
          year: _this.state.selectedDate,
          onSetYear: _this.onYearClick,
          light: textColor
        })
