...
var PopupText = /** @class */ (function (_super) {
    ...
    PopupText.prototype.render = function () {
        ...
        return (createElement("a", { href: "", onClick: createClickHandler(widgetOptions), style: this.props.styles || {} }, this.props.text));
    };
    return PopupText;
}(Component));
...
export { InlineWidget, PopupText, PopupWidget, CalendlyEventListener, openPopupWidget, closePopupWidget };
